...
router.get(
  ...
  historyQueryValidation,
  validateRequest,
  (req: Request, res: Response, next: NextFunction) => walletController.getHistory(req, res, next)
);
...
router.post(
  ...
  depositValidation,
  validateRequest,
  (req: Request, res: Response, next: NextFunction) => walletController.deposit(req, res, next)
);
...
router.get(
  ...
  getBalanceValidation,
  validateRequest,
  (req: Request, res: Response, next: NextFunction) => walletController.getBalance(req, res, next)
);
