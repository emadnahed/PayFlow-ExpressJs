...
router.get('/me/history', historyQueryValidation, (req: Request, res: Response, next: NextFunction) => walletController.getHistory(req, res, next));

// POST /wallets/me/deposit - Deposit funds (testing/admin)
router.post('/me/deposit', depositValidation, (req: Request, res: Response, next: NextFunction) => walletController.deposit(req, res, next));

// GET /wallets/:id/balance - Get wallet balance by ID
router.get('/:id/balance', getBalanceValidation, (req: Request, res: Response, next: NextFunction) => walletController.getBalance(req, res, next));
